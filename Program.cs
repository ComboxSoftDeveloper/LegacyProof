...
using LegacyProof.Benchmarks;
using LegacyProof.Diagnostics;
...
internal static class Program
{
    ...
    private static int Main(string[] args)
    {
        ...
        return mode switch
        {
            "checks" => Checks.Run(),
            "inherit" => Inherit.Run(),
            "covariance" => Covariance.Run(),
            "matrices" => Matrices.Run(),
            _ => Bench(args),
        };
    }
    ...
    private static int Bench(string[] args)
    {
        ...
        BenchmarkSwitcher
            .FromTypes([typeof(InheritBench), typeof(SpanBench), typeof(MatrixBench)])
