...
; LegacyProof.Benchmarks.MatrixBench.Multiply4x4()
       ...
       lea       r8,[rsp+20]
       mov       rcx,rbx
       call      qword ptr [7FFDF2A4FB58]; LegacyProof.Subjects.Multiply(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       mov       rax,rbx
       vzeroupper
       add       rsp,0A0
       pop       rbx
...
; LegacyProof.Benchmarks.MatrixBench.Add4x4()
       ...
       lea       r8,[rsp+20]
       mov       rcx,rbx
       call      qword ptr [7FFDF2A5FB70]; LegacyProof.Subjects.Add(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       mov       rax,rbx
       vzeroupper
       add       rsp,0A0
       pop       rbx
...
; LegacyProof.Benchmarks.MatrixBench.Multiply3x2()
       ...
       lea       r8,[rsp+20]
       mov       rcx,rbx
       call      qword ptr [7FFDF2A6FB70]; LegacyProof.Subjects.Multiply(System.Numerics.Matrix3x2, System.Numerics.Matrix3x2)
       mov       rax,rbx
       add       rsp,50
       pop       rbx
       ret
...
; LegacyProof.Benchmarks.MatrixBench.Multiply4x4()
       ...
       lea       rdx,[rsp+60]
       lea       r8,[rsp+20]
       call      qword ptr [7FFDC8EA6970]; LegacyProof.Subjects.Multiply(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       mov       rax,rbx
       vzeroupper
       add       rsp,0A0
       pop       rbx
...
; LegacyProof.Subjects.Multiply(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       ...
       lea       rdx,[rsp+0A0]
       lea       r8,[rsp+60]
       call      qword ptr [7FFDC8DDDCB0]; System.Numerics.Matrix4x4+Impl.op_Multiply(Impl ByRef, Impl ByRef)
...
; LegacyProof.Benchmarks.MatrixBench.Add4x4()
       ...
       lea       rdx,[rsp+60]
       lea       r8,[rsp+20]
       call      qword ptr [7FFDC8EA69A0]; LegacyProof.Subjects.Add(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       mov       rax,rbx
       vzeroupper
       add       rsp,0A0
       pop       rbx
...
; LegacyProof.Benchmarks.MatrixBench.Multiply3x2()
       ...
       lea       rdx,[rsp+38]
       lea       r8,[rsp+20]
       call      qword ptr [7FFDC8E964A8]; LegacyProof.Subjects.Multiply(System.Numerics.Matrix3x2, System.Numerics.Matrix3x2)
       mov       rax,rbx
       add       rsp,50
       pop       rbx
       ret
...
; LegacyProof.Benchmarks.MatrixBench.Multiply4x4()
       ...
       lea       r8,[rsp+20]
       mov       rcx,rbx
       call      qword ptr [7FFDB4D7ED30]; LegacyProof.Subjects.Multiply(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       mov       rax,rbx
       vzeroupper
       add       rsp,0A0
       pop       rbx
...
; LegacyProof.Benchmarks.MatrixBench.Add4x4()
       ...
       lea       r8,[rsp+20]
       mov       rcx,rbx
       call      qword ptr [7FFDB4D9EE08]; LegacyProof.Subjects.Add(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       mov       rax,rbx
       vzeroupper
       add       rsp,0A0
       pop       rbx
...
; LegacyProof.Benchmarks.MatrixBench.Multiply3x2()
       ...
       lea       r8,[rsp+20]
       mov       rcx,rbx
       call      qword ptr [7FFDB4DAEE08]; LegacyProof.Subjects.Multiply(System.Numerics.Matrix3x2, System.Numerics.Matrix3x2)
       mov       rax,rbx
       add       rsp,50
       pop       rbx
       ret
