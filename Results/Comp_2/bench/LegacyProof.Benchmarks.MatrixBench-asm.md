...
; LegacyProof.Benchmarks.MatrixBench.Multiply4x4()
       ...
       lea       r8,[rsp+20]
       mov       rcx,rbx
       call      qword ptr [7FFADACEFCD8]; LegacyProof.Subjects.Multiply(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       mov       rax,rbx
       vzeroupper
       add       rsp,0A0
       pop       rbx
...
; LegacyProof.Benchmarks.MatrixBench.Add4x4()
       ...
       lea       r8,[rsp+20]
       mov       rcx,rbx
       call      qword ptr [7FFADAD0FCD8]; LegacyProof.Subjects.Add(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       mov       rax,rbx
       vzeroupper
       add       rsp,0A0
       pop       rbx
...
; LegacyProof.Benchmarks.MatrixBench.Multiply3x2()
       ...
       lea       r8,[rsp+20]
       mov       rcx,rbx
       call      qword ptr [7FFADAD1FBE8]; LegacyProof.Subjects.Multiply(System.Numerics.Matrix3x2, System.Numerics.Matrix3x2)
       mov       rax,rbx
       add       rsp,50
       pop       rbx
       ret
...
; LegacyProof.Benchmarks.MatrixBench.Multiply4x4()
       ...
       lea       rdx,[rsp+60]
       lea       r8,[rsp+20]
       call      qword ptr [7FFACD9CF3A8]; LegacyProof.Subjects.Multiply(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       mov       rax,rbx
       add       rsp,0A0
       pop       rbx
       ret
...
; LegacyProof.Subjects.Multiply(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       ...
       lea       rdx,[rsp+0A0]
       lea       r8,[rsp+60]
       call      qword ptr [7FFACD926A30]; System.Numerics.Matrix4x4+Impl.op_Multiply(Impl ByRef, Impl ByRef)
...
; LegacyProof.Benchmarks.MatrixBench.Add4x4()
       ...
       lea       rdx,[rsp+60]
       lea       r8,[rsp+20]
       call      qword ptr [7FFACD9DF3D8]; LegacyProof.Subjects.Add(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       mov       rax,rbx
       add       rsp,0A0
       pop       rbx
       ret
...
; LegacyProof.Benchmarks.MatrixBench.Multiply3x2()
       ...
       lea       rdx,[rsp+38]
       lea       r8,[rsp+20]
       call      qword ptr [7FFACD9BF3C0]; LegacyProof.Subjects.Multiply(System.Numerics.Matrix3x2, System.Numerics.Matrix3x2)
       mov       rax,rbx
       add       rsp,50
       pop       rbx
       ret
...
; LegacyProof.Benchmarks.MatrixBench.Multiply4x4()
       ...
       lea       r8,[rsp+20]
       mov       rcx,rbx
       call      qword ptr [7FFACD8CECE8]; LegacyProof.Subjects.Multiply(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       mov       rax,rbx
       vzeroupper
       add       rsp,0A0
       pop       rbx
...
; LegacyProof.Benchmarks.MatrixBench.Add4x4()
       ...
       lea       r8,[rsp+20]
       mov       rcx,rbx
       call      qword ptr [7FFACD8FEDC0]; LegacyProof.Subjects.Add(System.Numerics.Matrix4x4, System.Numerics.Matrix4x4)
       mov       rax,rbx
       vzeroupper
       add       rsp,0A0
       pop       rbx
...
; LegacyProof.Benchmarks.MatrixBench.Multiply3x2()
       ...
       lea       r8,[rsp+20]
       mov       rcx,rbx
       call      qword ptr [7FFACD8CEDC0]; LegacyProof.Subjects.Multiply(System.Numerics.Matrix3x2, System.Numerics.Matrix3x2)
       mov       rax,rbx
       add       rsp,50
       pop       rbx
       ret
